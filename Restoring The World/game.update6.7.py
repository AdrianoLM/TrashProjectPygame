...
tela_instru = pygame.image.load("instruct.png").convert()
...
pygame.mixer.music.load('Menusic.mpeg')
...
def clicou(pos_mouse):
      if (pos_mouse[0] >= pos_botao_1[0]) and (pos_mouse[0] <= (pos_botao_1[0] + largura_botao_1)) and (pos_mouse[1] >= pos_botao_1[1]) and (pos_mouse[1] <= (pos_botao_1[1] + altura_botao_1)):
            ...
            print ("clicou 3")
            return 3
      elif ((pos_mouse[0] >= pos_botao_4[0] and pos_mouse[0] <= pos_botao_4[0] + largura_botao_4) and (pos_mouse[1] >= pos_botao_4[1] and pos_mouse[1] <= pos_mouse[1] + altura_botao_4)):
            return 4

      elif ((pos_mouse[0] >= pos_botao_5[0] and pos_mouse[0] <= pos_botao_5[0] + largura_botao_5) and (pos_mouse[1] >= pos_botao_5[1] and pos_mouse[1] <= pos_mouse[1] + altura_botao_5)):
            return 5
...
while main == True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if clicou(pos_mouse) ==1:
                ...
                sys.exit()
                main = False
            elif clicou(pos_mouse)==4:
                som = True
                pygame.mixer.music.play()
                    
            elif clicou(pos_mouse)==5:
                som = False
                pygame.mixer.music.stop()
    ...
    menu_list.draw(world) #draw the menu
